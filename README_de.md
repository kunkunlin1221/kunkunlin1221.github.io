...
_Dies ist der Quellcode meiner Homepage. Ich baue diese Website basierend auf [minimal](https://github.com/orderedlist/minimal)._
<br>
_Sie können den Quellcode jederzeit verwenden und freigeben._
...
_Sie müssen [Ruby](https://www.ruby-lang.org/en/) und [Jekyll](https://jekyllrb.com/) fisrt installieren._
...
1. [Kopieren Sie die Originalvorlage](https://github.com/yaoyao-liu/minimal-light/blob/master/_layouts/homepage.html) aus dem Repository des Themas<br />(_Tipp: Klicken Sie auf "raw", um das Kopieren zu vereinfachen_)

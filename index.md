...
- **Deep Learing**: Domain generalization, self-supervised learning, vision-language large models, multimodal large language models, vision language action model, model editing, knowledge distillation, model compression, and transfer learning.
